...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->benefits_Label = (gcnew System::Windows::Forms::Label());
			...
			this->groupBox1->Location = System::Drawing::Point(17, 63);
			...
			this->groupBox3->Location = System::Drawing::Point(299, 148);
			...
			this->date_Label->Location = System::Drawing::Point(79, 41);
			...
			this->label5->Location = System::Drawing::Point(27, 41);
			...
			this->Salary_Label->Location = System::Drawing::Point(86, 97);
			...
			this->label10->Location = System::Drawing::Point(30, 97);
			...
			this->Name_Label->Location = System::Drawing::Point(86, 71);
			...
			this->label6->Location = System::Drawing::Point(27, 71);
			...
			this->income_Label->Location = System::Drawing::Point(199, 67);
			...
			this->label8->Location = System::Drawing::Point(151, 67);
			...
			this->label16->Location = System::Drawing::Point(22, 18);
			...
			this->SelectionMenu->Location = System::Drawing::Point(93, 15);
			...
			// groupBox4
			// 
			this->groupBox4->Controls->Add(this->benefits_Label);
			...
			this->groupBox4->Location = System::Drawing::Point(299, 18);
			...
			this->groupBox4->Size = System::Drawing::Size(303, 126);
			...
			this->hours_label->Location = System::Drawing::Point(91, 41);
			...
			this->label17->Location = System::Drawing::Point(25, 41);
			...
			this->taxes_Label->Location = System::Drawing::Point(91, 67);
			...
			this->label14->Location = System::Drawing::Point(27, 67);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(88, 206);
			this->button2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(68, 39);
			...
			this->closePage->Location = System::Drawing::Point(626, 0);
			...
			this->label3->Text = L"Benefits:";
			// 
			// benefits_Label
			// 
			this->benefits_Label->AutoSize = true;
			this->benefits_Label->Location = System::Drawing::Point(91, 95);
			this->benefits_Label->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->benefits_Label->Name = L"benefits_Label";
			this->benefits_Label->Size = System::Drawing::Size(44, 13);
			this->benefits_Label->TabIndex = 25;
			this->benefits_Label->Text = L"benefits";
			// 
			// payroll_manage
			// 
...
private: System::Void SelectionMenu_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) {
	...
	try {
		...
		//We can move the total cost of the benefits to the payroll table to simplify this query
		//Then set benefits_Label to totalCostOfBenefits
		//And add the logic for that to whatever other calculations are producing the gross income
		//Then it'll pretty much be done
